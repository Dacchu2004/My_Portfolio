...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="scroll-mt-0 py-20 bg-gray-50 dark:bg-gray-800">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <button
              ...
              className="relative overflow-hidden w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
