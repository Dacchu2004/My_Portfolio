...
const skills = [
  ...
  },
  {
    ...
    description: "HTML5, CSS3, JavaScript, Flask, PERN, Tailwind CSS, Postgres SQL, SQL Alchemy",
    projects: 5,
  },
  {
    ...
    description: "Postgres SQL, SQL Alchemy, Prisma ORM",
    projects: 5,
  },
  {
...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={sectionRef} className="scroll-mt-0 py-16 md:py-24 bg-white dark:bg-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div
          ref={skillsRef}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-16 sm:mb-20 px-2 sm:px-0"
        >
            ...
            >
              ...
              <div className="relative p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div
                    className={`p-2 sm:p-3 lg:p-4 rounded-xl lg:rounded-2xl bg-gradient-to-r ${skill.color} text-white group-hover:scale-110 transition-transform duration-300`}
                  >
                    {skill.icon}
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-800 dark:text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                      {skill.name}
                    </h3>
