...
export default function Projects() {
  ...
  // Auto-play functionality - always on, only pauses on hover
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <button
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-white dark:bg-gray-800 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center text-gray-800 dark:text-white hover:bg-blue-600 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed z-30 group md:left-4"
            aria-label="Previous project"
          >
            <ChevronLeft className="w-3 h-3 sm:w-4 sm:h-4 md:w-6 md:h-6 lg:w-7 lg:h-7 group-hover:scale-110 transition-transform" />
          </button>

          <button
            onClick={nextSlide}
            disabled={isAnimating}
            className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-white dark:bg-gray-800 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center text-gray-800 dark:text-white hover:bg-blue-600 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed z-30 group md:right-4"
            aria-label="Next project"
          >
            <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 md:w-6 md:h-6 lg:w-7 lg:h-7 group-hover:scale-110 transition-transform" />
          </button>
